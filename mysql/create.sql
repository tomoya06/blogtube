...
CREATE TABLE IF NOT EXISTS `blogtube`.`user` (
  ...
  UNIQUE INDEX `user_UNIQUE` (`username` ASC, `role` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `blogtube`.`view_count`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blogtube`.`view_count` ;

CREATE TABLE IF NOT EXISTS `blogtube`.`view_count` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `view_id` INT NOT NULL,
  `view_type` INT(4) NOT NULL DEFAULT 0 COMMENT '0: article',
  `count` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  UNIQUE INDEX `view_UNIQUE` (`view_id` ASC, `view_type` ASC))
ENGINE = InnoDB;
