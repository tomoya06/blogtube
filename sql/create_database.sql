...
CREATE TABLE IF NOT EXISTS `blogtube`.`user` (
  ...
  `rank` INT(4) NOT NULL DEFAULT 1 COMMENT 'RANK.\nFROM 1 to 12',
...
-- -----------------------------------------------------
-- Table `blogtube`.`admin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blogtube`.`admin` ;

CREATE TABLE IF NOT EXISTS `blogtube`.`admin` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `username` VARCHAR(45) NOT NULL,
  `password` VARCHAR(255) NOT NULL,
  `created_time` DATETIME NOT NULL DEFAULT NOW(),
  `role` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Indicate Admin Permission\n1: READ/WRITE\n0: READ ONLY',
  `bio` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `blogtube`.`comment` (
  ...
  `content` TEXT NULL,
  `is_banned` TINYINT(1) NOT NULL DEFAULT 0,
  `target_type` INT(4) NOT NULL DEFAULT 0 COMMENT 'COMMENT TO WHOM?\n0: ARTICLE\n1: COMMENT\n2: CHANNEL',
  `user_id` INT NOT NULL,
